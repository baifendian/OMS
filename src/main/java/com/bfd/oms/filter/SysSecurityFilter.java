...
public class SysSecurityFilter extends AbstractSecurityInterceptor implements Filter {
	...
	@Autowired
	private SysAccessDecisionManager	accessDecisionManager;
	@Autowired
	private AuthenticationManager		sysAuthenticationManager;

	@PostConstruct
	public void init() {
		// System.err.println(" --------------- MySecurityFilter
		// init--------------- ");
		super.setAuthenticationManager(sysAuthenticationManager);
